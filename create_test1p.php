...
if(isset($_GET['selection'])&&!empty($_GET['selection'])){
	...
	$query = "INSERT INTO questions (test_id,type,variant_num,price) VALUES ('$test_id','$type','$variant_num','$price')";
	if(@$result=mysqli_query($connect, $query)){
		$query2 = "UPDATE counters SET quest_counter='$next_quest_counter'";
		if(@$result2 = mysqli_query($connect, $query2)){
			header("Location: create_test2p.php");
		}else{
...
<body>
	<div id="wrapper">
		...
		<section id="main_section" align="center">
			<form action="create_test1p.php" id="generalform" method="GET" name="forma" style="padding: 40px; text-align: center; font-size: 15px;">
				<div class="field">
